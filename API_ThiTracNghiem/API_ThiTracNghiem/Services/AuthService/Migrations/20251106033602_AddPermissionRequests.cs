    ...
    public partial class AddPermissionRequests : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PermissionRequests", x => x.PermissionRequestId);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 11, 6, 3, 36, 1, 355, DateTimeKind.Utc).AddTicks(6722), "Administrator role", "Admin", null },
                    { 2, new DateTime(2025, 11, 6, 3, 36, 1, 355, DateTimeKind.Utc).AddTicks(6724), "Teacher role", "Teacher", null },
                    { 3, new DateTime(2025, 11, 6, 3, 36, 1, 355, DateTimeKind.Utc).AddTicks(6725), "Student role", "Student", null }
                });
