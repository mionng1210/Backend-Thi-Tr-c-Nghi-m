...
namespace ExamsService.DTOs
{
    ...
    public class SubmitExamRequest
    {
        ...
        public int? TimeSpentSeconds { get; set; } // ✅ Optional: actual time spent from frontend (in seconds)
    }
    ...
    public class SubmitExamResponse
    {
        ...
        public DateTime StartTime { get; set; } // ✅ Added StartTime for accurate time calculation
        public DateTime SubmittedAt { get; set; }
        public int TimeSpentMinutes { get; set; }
        public int TimeSpentSeconds { get; set; } // ✅ Added TimeSpentSeconds for accurate display (in seconds)
